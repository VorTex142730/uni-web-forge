      ...
      <div className="p-6 text-center">
        ...
        <div className="mb-2">
          <div className={cn(
            ...
            member.role === 'Student' ? "bg-blue-100 text-blue-800" : "bg-purple-100 text-purple-800"
          )}>
            {member.role || 'Member'}
          </div>
        </div>
        
        <Link to={`/profile/${member.id}`} className="text-lg font-semibold hover:text-blue-600 block">
          {member.name}
        </Link>
